...
/**
 * Fixture (d), half B: a NON-shared class — `com.example.` matches no shared prefix — that
 * `:loader:fixtures:util-a` also declares, under the same fully-qualified name, with a
 * different body.
 *
