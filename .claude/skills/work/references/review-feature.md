...
background job's notification, which wakes nothing. Run long commands in the
foreground with a generous timeout, or poll a background job's output file
with ordinary foreground calls. Out of room, out of time, or blocked, give the
