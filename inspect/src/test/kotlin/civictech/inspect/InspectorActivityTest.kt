...
class InspectorActivityTest {
    ...
    private fun listen(on: InspectorServer = server): SseTap<Event> {
    ...
    private fun SseTap<Event>.awaitKind(kind: String, count: Int): List<kotlinx.serialization.json.JsonObject> =
