...
import { showErrors, setShowErrors, showFlow, setShowFlow, showHosts, setShowHosts, showState, setShowState } from '../solid/toggles';
 ...
 *  Implement §2 made "Errors" functional; M3-FE ticket Implement §2 makes
 *  "Flow" functional here. "Network hosts" (M5) stays disabled with a
 *  tooltip naming its milestone, same convention as M0-FE. */
const TOGGLES: {
  key: string;
  label: string;
  milestone: string;
...
const FUNCTIONAL = new Set(['hosts', 'state', 'errors', 'flow']);
