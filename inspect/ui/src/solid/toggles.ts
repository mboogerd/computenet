 ...
 *  (M2-FE ticket Implement §2). "Network hosts" (M5) and "Flow" (M3) stay
 *  disabled — `ToggleBar` still renders all five, per the M0-FE precedent,
 *  so the toggle set itself never changes shape across milestones. */
