...
| alignment | `./gradlew :demo:alignment:run --args="8096"` | Team alignment: rate ideas 1–9 per creator-defined dimension, creator-weighted live aggregate with a split marker, JSON API + SSE |
