...
| alignment | `./gradlew :demo:alignment:run --args="8096"` | Team alignment: rate ideas 1–9 per creator-defined dimension, creator-weighted live value ÷ cost aggregate with facilitator-configured dimension direction and a split marker, JSON API + SSE |
