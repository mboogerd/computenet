...
/**
 * The `:iroh` module's own multicast-**delivery** self-test (`ne2oh-B6`), the
 * JVM twin of `iroh/sidecar/tests/mdns.rs`'s `multicast_delivery`.
 * `:demo:beadsmirror` has its own copy planned under feature
 * `computenet-63um5` — a different module and a different claim, deliberately
...
object MulticastGate {
     ...
     * failure. Call this after [SidecarBinary.orSkip]; a test that spawns real
