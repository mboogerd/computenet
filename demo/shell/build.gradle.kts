...
// (see doc/archive/runs/RESTRUCTURE-PLAN.md RS-9.3/9.4) — and by :inspect,
// which reuses the same HTTP/SSE shell rather than duplicating it, even
// though :inspect is not itself a demo. DemoShell itself is transport
